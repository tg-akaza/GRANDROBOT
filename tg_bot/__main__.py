...
TECHNO_IMG = "https://telegra.ph/file/5363aa360b60b925b7b51.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/UpperMoonX3")],
                                                                                   [InlineKeyboardButton(text="ADD AKAZA BOT TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/tg-akaza/GRANDROBOT")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("Abe zinda hi hu , zyada dimaag kharab mat kr lomdike")
